...
import com.sora.util.akatsuki.CodeGenerationTestBase.TestEnvironment.FieldFilter;
	...
	public static class TestEnvironment {
		...
		public TestEnvironment(TestBase base, List<JavaSource> sources) {
			...
			try {
				...
				retainer = Internal.createRetainer(result.classLoader, retainerCache, testClass,
						Retained.class);
