...
public class LotsOfTypes {
	...
	// @Retained Map<String, Map<Integer, Parcelable>> spacialMap;
	// @Retained Map<?, Map<? super Integer, ? extends Parcelable>> spacialMap2;
	// @Retained Map<List<String>, Map<? super Object, ? extends List<? extends
	// CharSequence>>>
	// spacialMap3;

//	static class Generic<T extends Parcelable> {
//
//		@Retained T t;
//
//	}
//
//	static class Generic2<A extends B, B extends C, C extends Parcelable & Serializable> {
//
//		@Retained A a;
//
//	}
//
//	static class GenericIntersection<T extends Parcelable & Serializable> {
//
//		@Retained T t;
//
//	}
//
//	static class GenericInheritance<T extends Serializable> extends Generic<Bundle> {
//		@Retained T t;
//	}
...
//		@Retained String b;
//		@Retained String c;
//		@Retained A retainedA;
//
//		static class C {
//			@Retained(skip = true) String c;
//
